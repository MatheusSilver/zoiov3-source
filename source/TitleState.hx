...
class TitleState extends MusicBeatState
{
	...
	var easterEggKeyCombination:Array<FlxKey> = [FlxKey.Z, FlxKey.O, FlxKey.I, FlxKey.O]; //WTF IS ZOIO BROH
	...
	function startIntro()
	{
		...
		FlxTween.tween(logoBl, {y: logoBl.y + 50}, 0.6, {ease: FlxEase.quadInOut, type: PINGPONG}); //KEKKEKEKEKK
		...
		logoSpr = new FlxSprite(0, FlxG.height * 0.4).loadGraphic(Paths.image('credits/discord'));
		add(logoSpr);
		logoSpr.visible = false;
		logoSpr.setGraphicSize(Std.int(logoSpr.width * 1.1));
